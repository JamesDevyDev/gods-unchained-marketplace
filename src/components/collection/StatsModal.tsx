                ...
                <div className="p-6">
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-6">
                        <div className="bg-light  rounded-lg p-4 text-center">
                            ...
                            <div className="text-[10px] text-gray-500 mt-1">Last sold prices</div>
                        </div>
                        <div className="bg-light  rounded-lg p-4 text-center">
                        ...
                        <div className="bg-light  rounded-lg p-4 text-center">
                            ...
                            <div className="text-[10px] text-gray-500 mt-1">Active listings</div>
                        </div>
                    </div>
                    ...
                    {stats.total_tokens > 0 && (
                        <div className="grid grid-cols-2 gap-4 mt-6">
                            <div className="bg-light  rounded-lg p-4 text-center">
                                <div className="text-xs text-gray-400 mb-1">Average per Token</div>
                                <div className="text-xl font-bold text-text">
                                    ${formatPrice(totalRealValue / stats.total_tokens)}
                                </div>
                            </div>
                            {stats.user_listing_stats && stats.user_listing_stats.total_listings > 0 && (
                                <div className="bg-light  rounded-lg p-4 text-center">
                                    <div className="text-xs text-gray-400 mb-1">Average Listing Price</div>
                                    <div className="text-xl font-bold text-text">
                                        ${formatPrice(stats.user_listing_stats.total_listed_value_usd / stats.user_listing_stats.total_listings)}
                                    </div>
                                </div>
                            )}
                        </div>
