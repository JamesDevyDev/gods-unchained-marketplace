...
// List Collectible Modal Component - UPDATED with Max button
const ListCollectibleModal = ({
    card,
    isOpen,
    onClose,
            ...
            <div className="bg-background rounded-lg p-4 sm:p-5 max-w-sm w-full border border-gray-700 relative max-h-[90vh] overflow-y-auto">
                ...
                <div className="grid grid-cols-2 gap-3 mb-4">
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-2">
                            <div className="bg-light rounded px-3 py-2 text-white text-sm flex-1">
                                {quantity} <span className="text-gray-400 text-xs">of {unlistedCount}</span>
                            </div>
                            <button
