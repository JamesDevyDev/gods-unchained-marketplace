...
//                                                 <div>
//                                                     <div className="text-xs text-gray-400 uppercase mb-1">Total Listings</div>
...
//                                                         {stats.lowestFloor
//                                                             ? `${stats.lowestFloor.price.toFixed(6)} ${stats.lowestFloor.currency}`
//                                                             : 'N/A'}
//                                                     </div>
//                                                 </div>
//                                             </div>
...
//                                                             <div className="text-xs text-gray-400">
//                                                                 {collection.cards_with_listings.toLocaleString()} listings
//                                                             </div>
                                            ...
                                            <div className="relative h-120 overflow-hidden cursor-pointer">
                                                ...
                                                <div className="absolute bottom-0 left-0 md:left-10 p-4 md:p-8 z-10">
                                                    ...
                                                    <div className="flex flex-wrap gap-4 md:gap-6 rounded-lg p-3 bg-black/20 border border-lines backdrop-blur-md">
                                                        ...
                                                        {collectionVolume?.volume?.['24h'] && (
                                                            <div>
                                                                <div className="text-xs text-gray-400 uppercase mb-1">24h Sales</div>
                                                                <div className="text-sm md:text-lg font-bold">
                                                                    {collectionVolume.volume['24h'].sales.toLocaleString()}
                                                                </div>
                                                            </div>
                                                        )}
                                                    </div>
