...
// Helper function
const getWalletAddressFromCookie = (): string | null => {
            ...
            <div className="z-10 bg-background border-lines border-b sticky top-16 px-2">
              ...
              <div className='flex items-center justify-start py-2 gap-8 text-text text-xl font-bold'>
                ...
                <div
                  ...
                  onClick={() => {
                    const walletAddress = getWalletAddressFromCookie();
                    ...
                    if (walletAddress) {
                      ...
                      console.error('No wallet address found in cookies');
